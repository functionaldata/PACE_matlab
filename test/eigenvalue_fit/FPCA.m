%[X] = FPCA(y,t,p)
% MODIFIED: FPCA WILL RETURN THE RAW COVARIANCE AS THE 37TH COMPONENT
...
function [X] = FPCA(y,t,p)
 ...
 %addpath('./PACE');
  ...
  [no_opt,sigma,lambda,phi,eigen,xi_est,xi_var,mu,muDense,bw_mu,xcov,bw_xcov,xcovfit,AIC,BIC,FVE,y_pred,y_predOrig,y_predDense,out1,...
	 out21,y,t, regular, rho_opt, sigmanew, mucopy, phicopy, eigencopy, out1copy, out21copy, xcovcopy, xcovfitcopy, xcorr, ops, rcov]...
...
Xnames = {'no_opt','sigma','lambda','phi','eigen','xi_est','xi_var','mu','muDense','bw_mu','xcov','bw_xcov','xcovfit',...
	  ...
	  'mucopy', 'phicopy','eigencopy','out1copy', 'out21copy', 'xcovcopy', 'xcovfitcopy','xcorr','ops', 'names', 'rcov'};
X = {no_opt,sigma,lambda,phi,eigen,xi_est,xi_var,mu,muDense,bw_mu,xcov,bw_xcov,xcovfit,AIC,BIC,FVE,...
     y_pred,y_predOrig,y_predDense,out1,out21, y,t, regular, rho_opt, sigmanew, mucopy, phicopy, eigencopy, out1copy, out21copy, xcovcopy, xcovfitcopy, xcorr, ops, Xnames, rcov};  
end
